...
@Composable
fun PopularDestinationsCardViewFun(
    countryName: String,
    countryImage: Int,
    famousPlace: String,
    ...
    Box(
        modifier = Modifier.height(140.dp).width(140.dp).background(color = Color.Transparent), contentAlignment = Alignment.Center
    ) {


        Image(
            painter = painterResource(countryImage),
            contentDescription = "",
            modifier = Modifier
                .fillMaxSize()
...
@Composable
fun PopularDestinationsCardViewFunPreview(){
